          ...
          <ul class="list-unstyled text-small">
            <li>
              <div class="rounded-circle text-light">
                ...
                <a class="text-muted" href="https://wa.me/6287776104111"
                  >+62 8777-7610-4111</a
                >
              </div>
            </li>
            <li>
              <div class="rounded-circle text-light">
                ...
                <a class="text-muted" href="mailto:+621-5695-4670"
                  >customercare@shf.co.id</a
                >
              </div>
            </li>
          </ul>
          ...
          <ul class="list-unstyled text-small">
            <li>
              <div class="rounded-circle text-light">
                ...
                <a class="text-muted" href="https://facebook.com/shf.co.id"
                  >Sinarmas Hana Finance</a
                >
              </div>
            </li>
            <li>
            ...
            <li>
              <div class="rounded-circle text-light">
                ...
                <a class="text-muted" href="https://twitter.com/shf_co_id"
                  >@shf_co_id</a
                >
              </div>
            </li>
