<template>
  ...
  >
    ...
    <path
      ...
      opacity="0.1"
    />
    <ellipse cx="579.79" cy="726.58" rx="370.98" ry="27.58" fill="#00bfa6" opacity="0.1" />
    <path
    ...
    <path
      ...
      fill="#00bfa6"
    />
    <ellipse cx="103.66" cy="753.23" rx="26.93" ry="4.55" fill="#00bfa6" opacity="0.1" />
    <ellipse cx="957.84" cy="753.23" rx="26.93" ry="4.55" fill="#00bfa6" opacity="0.1" />
    <ellipse cx="699.95" cy="779.42" rx="26.93" ry="4.55" fill="#00bfa6" opacity="0.1" />
    <ellipse cx="1000.43" cy="713.79" rx="26.93" ry="4.55" fill="#00bfa6" opacity="0.1" />
    <ellipse cx="156.07" cy="710.95" rx="26.93" ry="4.55" fill="#00bfa6" opacity="0.1" />
    <ellipse cx="45.44" cy="723.72" rx="26.93" ry="4.55" fill="#00bfa6" opacity="0.1" />
    <rect x="302.74" y="79.74" width="431.35" height="641.38" rx="9.8" ry="9.8" fill="#3a3768" />
    <rect x="342.22" y="134.87" width="357.73" height="126.09" rx="29.21" ry="29.21" opacity="0.1" />
    ...
    <rect x="615.53" y="313.48" width="71.14" height="79.04" rx="10.79" ry="10.79" fill="#00bfa6" />
    ...
    <rect x="615.53" y="400.43" width="71.14" height="79.04" rx="11.3" ry="11.3" fill="#00bfa6" />
    ...
    <rect x="649.87" y="237.98" width="31.14" height="3.37" fill="#00bfa6" />
    <rect x="604.28" y="237.98" width="31.14" height="3.37" fill="#00bfa6" />
    <rect x="558.68" y="237.98" width="31.14" height="3.37" fill="#00bfa6" />
    <rect x="513.09" y="237.98" width="31.14" height="3.37" fill="#00bfa6" />
    <path
