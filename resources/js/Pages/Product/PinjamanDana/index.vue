  ...
  <Layout>
    <div>
      ...
      <div
        ...
        style="background-size:cover; background-image:url(/img/demo/3.jpg);"
      >
        <div class="container text-center text-white h-100">
          <h3 data-aos="zoom-out-down">Pembiayaan</h3>
          <h1 data-aos="zoom-out-down" class="display-3">
            <strong>Pinjaman Dana</strong>
          </h1>
          <p
            data-aos="zoom-out"
            class="text-white"
          >Pembiayaan untuk memenuhi berbagai kebutuhan, baik bersifat konsumtif (biaya pendidikan, kesehatan dan kecantikan, pernikahan, renovasi rumah, wisata, dan lain-lain) maupun produktif (modal usaha dan investasi), dengan jangka waktu pembiayaan mulai 1 hingga 4 tahun dan suku bunga tetap.</p>
        </div>
      ...
      <div data-aos="fade-down" class="container mt-4">
        <div class="pb-4 pt-4 text-center">
          <h2 class="text-secondary">Pinjaman Dana Sinarmas Hana Finance</h2>
          <p class="text-muted">
...
export default {
  metaInfo: { title: "Produk Pinjaman Dana" },
  data() {
    return {
      reqItems: [
        {
