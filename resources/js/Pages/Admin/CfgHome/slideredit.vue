                ...
                <b-form id="form" @submit.prevent="submit">
                    <b-card-header class="p-0">
                        ...
                        <b-overlay :show="isHoverimg" no-center variant="dark">
                            <template #overlay>
                                <div class="float-right position-absolute" style="top: 12px; right: 12px">
                                    <b-button variant="outline-primary" v-b-tooltip.hover title="Fullscreen" @click="toggleFullscreen">
                                            <i class="fas fa-expand"></i>
                                    </b-button>
                                    <!-- <b-button variant="outline-primary" @click="previewFullscr">
                            ...
                            <fullscreen
                                ...
                                >
                                <b-img rounded="top" :src="form.image" fluid-grow alt="Responsive image" 
                                >
                                </b-img>
                            </fullscreen>
                        </b-overlay>
                    ...
                    <b-card-body>
                        <b-form-group
                            ...
                            :invalid-feedback="(errors.caption)?errors.caption[0]:''"
                        ...
                        <b-form-group label="Apakah akan di tampilkan ?">
                            <b-form-radio-group :disabled="!isEditmode" v-model="form.show" name="show">
                    ...
                    <b-card-footer :hidden="!isEditmode">
                        <b-button :disabled="!isEditmode" type="submit" variant="primary">Save</b-button>
                        <b-button :disabled="!isEditmode" type="button" variant="secondary" @click="doEditmode">Cancel</b-button>
                    </b-card-footer>
                </b-form>    
            </b-card>
          </div>
    ...
    data() {
        return {
            dropzoneOptions: {
                ...
                addRemoveLinks: true,
                dictDefaultMessage:
                "<i class='fas fa-cloud-upload-alt'></i><br/>Drop your slider here"
            },
            form: {
                caption:'',
                index:null,
