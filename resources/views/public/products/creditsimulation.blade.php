    ...
    <div class="container-fluid text-white h-100">
        <div class="d-lg-flex align-items-center justify-content-between text-center pl-lg-5">
            <div class="col pt-4 pb-4">
                <h2 class="display-3">Simulasi Kredit Sinarmas Hana Finance</h2>
                <h5 class="font-weight-light mb-4">Cepat dan Mudah</h5>
                <p>Untuk memudahkan perencanaan keuangan Anda, kami mempersembahkan halaman simulasi kredit ini spesial untuk Anda para calon nasabah kami. Setelah menggunakan kalkulator pembiayaan ini, Anda juga dapat langsung mengajukan kredit dan pinjaman dana secara online.</p>
